...
;(function( $ ){
	...
	$.fn.ruler = function(options) {
		var img = document.getElementById('white_bg'); 
		var widthPercent = 1600 / img.clientWidth;
		var heightPercent = 800 / img.clientHeight;
			...
			if (settings.showCrosshair || settings.showMousePos) {
				$(window).mousemove(function(e) {
					...
					if (settings.showMousePos) {
						...
						$('.mousePosBox').html("x:" + parseInt((e.pageX-settings.vRuleSize) * settings.widthPercent)
											+ ", y:" + parseInt((e.pageY-settings.hRuleSize) * settings.heightPercent)
											).css({
		...
		return this.each(function() {
			...
			// $('.test').html("width: "+width+", height: "+height);
